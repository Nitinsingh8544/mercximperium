...
const joinedMessages = [
  ...
  { name: "nitinrajput8544", initial: "N", color: "bg-primary text-primary-foreground" },
  { name: "qwerty", initial: "Q", color: "bg-secondary text-secondary-foreground" },
  { name: "abhijeetsharma110702", initial: "A", color: "bg-yellow-200 text-yellow-800" },
];
  ...
  return (
    <div className="bg-card rounded-xl border border-border h-full flex flex-col">
      ...
      <div className="flex border-b border-border">
        <div className="flex-1 py-3 text-sm font-medium text-center text-foreground border-b-2 border-secondary">
          Chat
        </div>
      </div>
