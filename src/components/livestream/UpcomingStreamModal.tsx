...
const UpcomingStreamModal = ({ isOpen, onClose, stream }: UpcomingStreamModalProps) => {
  ...
  // Simulate a scheduled time (random 1-4 hours from now)
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Hosted by <span className="font-medium text-foreground">{stream.host}</span></p>
          </div>
